...
from SimpleClip.common import HuggingFaceOpenClipModelZeroShotCollater, load_state_dict
...
class config:
    network = 'apple/DFN2B-CLIP-ViT-B-16'
    ...
    val_collater = HuggingFaceOpenClipModelZeroShotCollater()
