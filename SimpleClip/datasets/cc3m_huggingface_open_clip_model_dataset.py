...
if __name__ == '__main__':
    ...
    from SimpleClip.common import HuggingFaceOpenClipModelImageCaptionPairCollater
    ...
    train_processor = net.train_preprocess
    ...
    collater = HuggingFaceOpenClipModelImageCaptionPairCollater()
